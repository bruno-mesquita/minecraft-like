    ...
    pub fn from_chunk_mesh(device: &wgpu::Device, mesh: &ChunkMesh) -> Option<Self> {
        ...
        for (face_index, face) in mesh.vertices.iter().enumerate() {
            ...
            let face_vertices = match face.face {
                Face::Left => [
                    GpuVertex { position: [x, y, z], normal: [-1.0, 0.0, 0.0], color },
                    GpuVertex { position: [x, y, z + 1.0], normal: [-1.0, 0.0, 0.0], color },
                    GpuVertex { position: [x, y + 1.0, z + 1.0], normal: [-1.0, 0.0, 0.0], color },
                    GpuVertex { position: [x, y + 1.0, z], normal: [-1.0, 0.0, 0.0], color },
                ],
                Face::Right => [
                    GpuVertex { position: [x + 1.0, y, z + 1.0], normal: [1.0, 0.0, 0.0], color },
                    GpuVertex { position: [x + 1.0, y, z], normal: [1.0, 0.0, 0.0], color },
                    GpuVertex { position: [x + 1.0, y + 1.0, z], normal: [1.0, 0.0, 0.0], color },
                    GpuVertex { position: [x + 1.0, y + 1.0, z + 1.0], normal: [1.0, 0.0, 0.0], color },
                ],
                Face::Bottom => [
                    GpuVertex { position: [x, y, z + 1.0], normal: [0.0, -1.0, 0.0], color },
                    GpuVertex { position: [x, y, z], normal: [0.0, -1.0, 0.0], color },
                    GpuVertex { position: [x + 1.0, y, z], normal: [0.0, -1.0, 0.0], color },
                    GpuVertex { position: [x + 1.0, y, z + 1.0], normal: [0.0, -1.0, 0.0], color },
                ],
                Face::Top => [
                    GpuVertex { position: [x, y + 1.0, z], normal: [0.0, 1.0, 0.0], color },
                    GpuVertex { position: [x, y + 1.0, z + 1.0], normal: [0.0, 1.0, 0.0], color },
                    GpuVertex { position: [x + 1.0, y + 1.0, z + 1.0], normal: [0.0, 1.0, 0.0], color },
                    GpuVertex { position: [x + 1.0, y + 1.0, z], normal: [0.0, 1.0, 0.0], color },
                ],
                Face::Back => [
                    GpuVertex { position: [x + 1.0, y, z], normal: [0.0, 0.0, -1.0], color },
                    GpuVertex { position: [x, y, z], normal: [0.0, 0.0, -1.0], color },
                    GpuVertex { position: [x, y + 1.0, z], normal: [0.0, 0.0, -1.0], color },
                    GpuVertex { position: [x + 1.0, y + 1.0, z], normal: [0.0, 0.0, -1.0], color },
                ],
                Face::Front => [
                    GpuVertex { position: [x, y, z + 1.0], normal: [0.0, 0.0, 1.0], color },
                    GpuVertex { position: [x + 1.0, y, z + 1.0], normal: [0.0, 0.0, 1.0], color },
                    GpuVertex { position: [x + 1.0, y + 1.0, z + 1.0], normal: [0.0, 0.0, 1.0], color },
                    GpuVertex { position: [x, y + 1.0, z + 1.0], normal: [0.0, 0.0, 1.0], color },
                ],
            };
